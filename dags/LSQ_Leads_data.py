...
delete_table = PostgresOperator(
    ...
    postgres_conn_id='postgres_result_db',
    sql='''delete from IF EXISTS lsq_leads_x_activities where activity_id is null;
    ''',
    dag=dag
)
