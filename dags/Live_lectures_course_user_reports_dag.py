...
def extract_data_to_nested(**kwargs):
    ...
    for transform_row in transform_data_output:
        pg_cursor.execute(
            'INSERT INTO live_lectures_course_user_reports (table_unique_key,lecture_id,course_user_mapping_id,course_user_mapping_status,report_type,min_join_time,max_leave_time,inst_total_time as inst_total_time_in_mins,total_time_spent_in_mins as user_total_time_spent_in_mins,overlapping_time_in_mins,lecture_understood_response,lecture_understood_rating,feedback_answer,answer_rating)'
...
create_table = PostgresOperator(
    ...
    sql='''CREATE TABLE IF NOT EXISTS live_lectures_course_user_reports (
            ...
            user_total_time_spent_in_mins int,
            overlapping_time_in_mins int,
