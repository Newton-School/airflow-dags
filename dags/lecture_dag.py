...
transform_data = PostgresOperator(
    ...
    sql='''select
            ...
            video_sessions_lecture.created_at as created_at,
            video_sessions_lecture.start_timestamp as start_timestamp,
            video_sessions_lecture.end_timestamp as end_timestamp,
