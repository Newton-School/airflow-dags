...
def extract_data_to_nested(**kwargs):
    ...
    for transform_row in transform_data_output:
        pg_cursor.execute(
            'INSERT INTO course_component_mapping (table_unique_key,'
            'course_id,'
            'course_name,'
            'course_component_id,'
            'module_name,'
            ...
            'topic_clearance_points = EXCLUDED.topic_clearance_points,'
...
dag = DAG(
    'course_component_mapping_dag',
    default_args=default_args,
    description='Course component mapping at module and topic (module accdng to normal nomenclature) level',
...
create_table = PostgresOperator(
    ...
    sql='''CREATE TABLE IF NOT EXISTS course_component_mapping (
            id serial,
...
transform_data = PostgresOperator(
    ...
    sql='''
        select 
            concat(courses_course.id,'_',cc2.object_id) as table_unique_key,
            ...
            cc2.title as topic_name,
            cc2.deadline_timestamp as topic_deadline_timestamp,
            cc2.unlock_timestamp as topic_unlock_timestamp,
            cc2.clearance_points as topic_clearance_points,
