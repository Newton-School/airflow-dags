...
def extract_data_to_nested(**kwargs):
    ...
    while True:
        ...
        pg_cursor.execute(
            'SELECT uaq_id,user_id,assignment_id,question_id,question_started_at,question_completed_at,'
            'completed,all_test_case_passed,playground_type,playground_id,hash,'
            ...
            'FROM assignment_question_user_mapping '
    ...
    return PostgresOperator(
        ...
        sql='''(with questions_released as(
                    ...
                    from questions_released
                        ...
                        assignments_assignmentcourseuserquestionmapping.game_playground_id,assignments_assignmentcourseuserquestionmapping.project_playground_id) final
