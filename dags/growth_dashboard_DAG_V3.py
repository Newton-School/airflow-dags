    ...
    sql='''with test_taken_1 as(
            select 
                    ...
                    from
                        assessments a 
                    join courses c 
                        on c.course_id = a.course_id and c.course_id in (800,818,819,820,821,822,823,824,825,826,1040,1041,1042,1043,1044,1045,1632,1633,1634,1635,1636)
...
raw as(
            ...
            where courses.course_id in (786,759,800,818,819,820,821,822,823,824,825,826,1040,1041,1042,1043,1044,1045,1632,1633,1634,1635,1636)
            order by 1
            ),
            b as(
            select
