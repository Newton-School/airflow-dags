...
raw as(
            ...
            from users_info
            left join course_user_timeline_flow_mapping on course_user_timeline_flow_mapping.user_id = users_info.user_id and course_user_timeline_flow_mapping.course_id in (786,759,800,818,819,820,821,822,823,824,825,826,1040,1041,1042,1043,1044,1045,1632,1633,1634,1635,1636)
            ...
            left join courses on courses.course_id = course_user_timeline_flow_mapping.course_id and courses.course_id in (786,759,800,818,819,820,821,822,823,824,825,826,1040,1041,1042,1043,1044,1045,1632,1633,1634,1635,1636)
