...
def extract_data_to_nested(**kwargs):
    ...
    for transform_row in transform_data_output:
        pg_cursor.execute(
            ...
            'user_id,student_name,date_joined,last_login,'
            'username,email,phone,current_location_city,'
            'current_location_state,gender,date_of_birth,'
            'utm_source,utm_medium,utm_campaign,tenth_marks,twelfth_marks,'
            'bachelors_marks,bachelors_grad_year,bachelors_field_of_study,'
            'masters_marks,masters_grad_year,masters_degree,masters_field_of_study,'
            'lead_type,topic_pool_id,template_name,'
            'course_id,course_name,course_structure_class,course_start_date,course_age,'
            'status,label_mapping_id,module_cutoff,'
            'rating, mock_rating,'
            'plagiarised_rating,'
            'required_rating,'
            'module_percent,'
...
transform_data = PostgresOperator(
    ...
    select 
        ...
        utm_medium,
        utm_campaign,
        round(tenth_marks,2) as tenth_marks,
        round(twelfth_marks,2) as twelfth_marks,
        round(bachelors_marks,2) as bachelors_marks,
        bachelors_grad_year,
        bachelors_field_of_study,
        round(masters_marks,2) as masters_marks,
        masters_grad_year, 
        masters_degree,
        ...
        plagiarised_rating,
        required_rating,
        round(module_percent,2) as module_percent,
        grade_obtained,
        assignment_rating,
        contest_rating,
        milestone_rating,
