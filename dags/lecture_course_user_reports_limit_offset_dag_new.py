...
def number_of_rows_per_lecture_sub_dag_func(start_lecture_id, end_lecture_id):
    return PostgresOperator(
        ...
        join lectures l
            ...
            and (l.lecture_id in (select lecture_id from recorded_lectures_course_user_reports where lecture_watch_date BETWEEN '2025-01-31' AND '2025-03-31')
                 or l.start_timestamp  BETWEEN '2025-01-31' AND '2025-03-31')
