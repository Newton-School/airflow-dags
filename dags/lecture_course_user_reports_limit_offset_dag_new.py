    ...
    try:
        ...
        sql_query = f'''
            ...
            JOIN lectures l
                ...
                AND (l.lecture_id IN (SELECT lecture_id FROM recorded_lectures_course_user_reports WHERE lecture_watch_date BETWEEN '2025-03-01' AND '2025-05-1')
                     OR l.start_timestamp BETWEEN '2025-03-01' AND '2025-05-1')
