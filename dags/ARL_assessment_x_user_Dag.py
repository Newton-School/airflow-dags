...
def extract_data_to_nested(**kwargs):
    ...
    for transform_row in transform_data_output:
        pg_cursor.execute(
            ...
            'assessment_title,assessment_type,assessment_sub_type,assessment_release_date,'
            ...
            'on conflict (table_unique_key) do update set assessment_open_date=Excluded.assessment_open_date,'
            ...
            'questions_correct=EXCLUDED.questions_correct,max_marks=EXCLUDED.max_marks,'
            'marks_obtained=EXCLUDED.marks_obtained,cheated=EXCLUDED.cheated;',
            (
                transform_row[0],
                transform_row[1],
                transform_row[2],
