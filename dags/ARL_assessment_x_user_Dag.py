...
transform_data = PostgresOperator(
    ...
    sql='''select
        ...
        from
            assessments
        join courses
            on courses.course_id = assessments.course_id and course_structure_id in (1,6,7,8,11,12,14,18,19,20,22,23,26,34,44) and date(assessments.start_timestamp) >= '2022-07-01'
